<template>
  <div>
    <div class="page-content-wrapper">
      ...
      <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner tiny-slider-one-wrapper">
          <div class="carousel-item active tiny-slider-one">
              <div>
          ...
          <div class="carousel-item tiny-slider-one">
              <div>
      ...
      <div class="container">
        <div class="card card-bg-img bg-img bg-overlay mb-3" style="background-image: url('/img/bg-img/3.jpg')">
          <div class="card-body direction-rtl p-5">
            ...
            <p class="mb-4 text-white">More than 220+ reusable modern design elements. Just copy the code and paste it on your desired page.</p><a class="btn btn-warning" href="#">All elements</a>
          </div>
        </div>
      </div>
      <div class="container direction-rtl">
      ...
      <div class="container">
        <div class="card bg-primary mb-3 bg-img" style="background-image: url('/img/core-img/1.png')">
          <div class="card-body direction-rtl p-5">
            ...
            <p class="mb-4 text-white">Already designed more than 100+ pages for your needs. Such as - Authentication, Chats, eCommerce, Blog &amp; Miscellaneous pages.</p><a class="btn btn-warning" href="#">All pages</a>
          </div>
        </div>
      </div>
      <div class="container direction-rtl">
  ...
  <div class="carousel-inner testimonial-slide-three-wrapper">
    <div class="carousel-item active testimonial-slide3 testimonial-style3">
    ...
    <div class="carousel-item testimonial-slide3 testimonial-style3">
        <div class="single-testimonial-slide">
            <div class="text-content"><span class="d-inline-block badge bg-warning mb-2"><i class="bi bi-star-fill me-1"></i><i class="bi bi-star-fill me-1"></i><i class="bi bi-star-fill me-1"></i><i class="bi bi-star-fill me-1"></i><i class="bi bi-star-fill"></i></span>
                <h6 class="mb-2">All complete, <br> great craft.</h6><span class="d-block">Mazatlumm, Themeforest</span>
            </div>
...
export default {
  ...
  methods:{
    async githubLogout(){
      const ip = await this.$axios.$post('http://127.0.0.1:8000/api/auth/logout')
      this.$auth.logout()
